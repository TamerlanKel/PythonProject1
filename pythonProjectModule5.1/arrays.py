# from module_4.sortfunc import insertion_sort, bubble_sort, selections_sort
#
...
#
# print(selections_sort(data_1))
# print(selections_sort(data_2))
# print(selections_sort(data_3))